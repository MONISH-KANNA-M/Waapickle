                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-accent/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary pl-10"
          ...
          <div className="card p-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <button className="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-300 transition-colors duration-200 flex items-center gap-2">
              ...
              <div>
                ...
                <button className="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-300 transition-colors duration-200">
                  Enable 2FA
                </button>
              </div>
