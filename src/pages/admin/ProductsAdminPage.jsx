    ...
    <div className="p-6 bg-bg min-h-screen animate-fadeIn">
      ...
      <div className="flex items-center justify-between mb-8 animate-slideInLeft">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2 font-heading">Products</h1>
            <p className="text-gray-600 font-body text-lg">Manage your pickle inventory</p>
          </div>
        </div>
        <Link
          to="/admin/add-product"
          className="bg-gradient-to-r from-primary to-accent text-white px-6 py-3 rounded-xl hover:from-hover hover:to-primary transition-all duration-200 transform hover:scale-105 flex items-center gap-2 font-body shadow-lg"
        >
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center">
          ...
          {selectedProducts.length > 0 && (
            <button
              ...
              className="bg-gray-200 text-red-600 hover:text-red-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-300 transition-colors duration-200"
            >
      ...
      {viewModalOpen && selectedProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative animate-fadeIn">
            ...
            <button onClick={() => setViewModalOpen(false)} className="w-full bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-300 transition-colors duration-200 mt-4">Close</button>
          </div>
        </div>
      )}
    </div>
